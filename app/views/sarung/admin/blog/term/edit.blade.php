...
@section('content')
    ...
    @if( Session::has('message')  )
        ...
        <div class="clear_25"></div>
    @endif
    {{ Form::open(array('url' => root::get_url_admin_blog_category('edit') , 'method' => 'post' ,
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
				<input  name="category_name" class="form-control "
						id="category_name"
						type="text" placeholder="Category" title="Name Category" required value="{{$category_name}}" >
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
				<input  name="slug_name" class="form-control "
						id="slug_name"
						type="text" placeholder="Slug" title="Slug Name" required value="{{$slug_name}}">
            </div>
        </div>
