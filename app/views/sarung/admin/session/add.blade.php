...
@section('title')
	Session|Add
@stop
@include( 'sarung.admin.session.common', array( 'foo' => 'bar' ) )

@section('content')
    <h1 class="title">Add Session
        <a href="{{ root::get_url_admin_session()}}" class="btn btn-primary btn-xs" >View</a>
    </h1>
    <hr class="mar_25">
    {{ Form::open(array('url' => root::get_url_admin_session('add') , 'method' => 'post' , 'role' => 'form' ,'class' => 'form-horizontal')) ; }}
