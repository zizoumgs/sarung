...
/*
*/
class Larangan_Meta_Controller extends admin{
    public function __construct(){
		parent::__construct(1);
		admin::init_helper(new Larangan_Meta_Helper);
	}
    ...
    public function getIndex(){
        ...
        return View::make( "sarung.admin.pelanggaran.larangan_meta.index" , $datas);
    }
	...
	*/
	public function getAdd(){
		...
		return View::make( "sarung.admin.pelanggaran.larangan_meta.add" , $datas);
	}
