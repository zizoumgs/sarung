...
@section('content')
    ...
    <hr class="mar_25">
	<div class="col-md-8">
	{{ Form::open( array('url' => root::get_url_admin_larangan_meta('edit/') , 'method' => 'post' ,
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-9">
			  <input class="form-control" type="number" name="point_name" value="{{ $point_name}}" />
		</div>
	</div>
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-9">
			<textarea class="form-control" rows="5" id="hukuman_name" name="hukuman_name">{{ $hukuman_name}}</textarea>
		</div>
	</div>
