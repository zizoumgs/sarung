...
@section('title')
	Nama Pelanggaran | Edit
@stop

@section('content')
    <h1 class="title">Edit Nama Pelanggaran
    ...
    @endif		
	<div class="col-md-8">
	{{ Form::open( array('url' => root::get_url_admin_nama_pelanggaran('edit/') , 'method' => 'post' ,
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-9">
			{{ Form::text('nama_pelanggaran_name', $nama_pelanggaran_name , array('id' => 'nama_pelanggaran_name' , 'class' => 'form-control' )) }}
		</div>
	</div>
	<div class="form-group">
