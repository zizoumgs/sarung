...
@section('content')
    <h1 class="title">Delete Santri
        <a href="{{ root::get_url_admin_user()}}" class="btn btn-primary btn-xs" >View</a>
    </h1>
	
    <hr class="mar_25">
	<div class="col-md-8">
	{{ Form::open( array('url' => root::get_url_admin_santri('delete') , 'method' => 'post' ,
	    'role' => 'form'            ,   'class' => 'form-horizontal',
        'name' => 'dialog_delete_name'     ,   'id'    => 'dialog_delete_name'
     ) ) }}
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
			...
			'class' => 'form-control' ,
			'title' => 'Kosongkan untuk yang belum berhenti' ,'readonly' =>'' 	)) }}
    	</div>
    </div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
	        {{ Form::text('id_santri_name', $id_santri_name ,
			array('id' => 'id_santri_name' , 'class' => 'form-control' ,'ReadOnly'=>'' )) }}
    	</div>
    </div>
    <div class="form-group">
		<label for="dialog_santri_name" class="col-sm-3 control-label">Santri Name</label>
		<div class="col-sm-9">
	       {{ Form::text('santri_name', $santri_name ,
		   array('id' => 'santri_name' , 'class' => 'form-control' ,'ReadOnly'=>'' )) }}
		</div>
    </div>
    <div class="form-group">
