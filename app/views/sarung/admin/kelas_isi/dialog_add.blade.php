    ...
    <div class="modal-dialog">
    	<div class="modal-content">
			...
			<div class="modal-body">
                {{ Form::open( array('url' => root::get_url_admin_kelas_isi('add') , 'method' => 'post' ,
    			...
    			<div class="form-group">
    				<label for="dialog_kelas_name" class="col-sm-3 control-label">Kelas</label>
                    <div class="col-sm-9">
        				<select class="form-control col-sm-2" name="dialog_kelas_name">
                ...
                <div class="form-group">
    				<label for="dialog_santri_id" class="col-sm-3 control-label">Id Santri</label>
       				<div class="col-sm-9">
                        {{ Form::text('dialog_santri_id', '' , array('id' => 'dialog_santri_id' , 'class' => 'form-control' ,'ReadOnly'=>'' )) }}
       				</div>
    			</div>
                <div class="form-group">
                ...
                <div class="form-group">
    				<label for="dialog_catatan_name" class="col-sm-3 control-label">Catatan</label>
       				<div class="col-sm-9">
						{{ Form::TextArea(	'dialog_catatan_name', '' ,
										array('id' => 'dialog_catatan_name' ,
