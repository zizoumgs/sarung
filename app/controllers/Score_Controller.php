<?php
class Score_helper extends Controller {
    protected $where_text   = "" ;
    protected $where_values = array()  ;
	protected $where_url = array();
...
/**
*/
class Score_Controller extends Score_helper{
    public function __construct(){
        parent::__construct();
    }
    /*
    ...
    */
    ...
    public function anyIndex(){        
		...
		return View::make('score', array('posts'    =>  $posts ,
