...
@section('content')
    <h1 class="title">Edit Session
        <a href="{{ root::get_url_admin_session()}}" class="btn btn-primary btn-xs" >View</a>
    </h1>
    <hr class="mar_25">
    {{ Form::open(array('url' => root::get_url_admin_session('edit') , 'method' => 'post' , 'role' => 'form' ,'class' => 'form-horizontal')) ; }}
        {{ Form::hidden('id',  $id ) }}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
				<input  name="{{ Session_Helper::get_nilai_name }}" class="form-control "
						type="text" placeholder="Standard ketidak-naikan" title="Total santri tidak naik" value="{{ $tidak_naik_value}}" >
            </div>
        </div>
		<hr>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
				<input  name="{{ Session_Helper::get_session_name }}" class="form-control "
						type="text" placeholder="Session" title="Name Example: 07-08" value="{{ $session_value}}" >
            </div>
        </div>
