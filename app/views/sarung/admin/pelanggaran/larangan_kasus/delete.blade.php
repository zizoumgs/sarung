...
@section('content')
    ...
    <hr class="mar_25">
	<div class="col-md-8">
	{{ Form::open( array('url' => root::get_url_admin_larangan_kasus('delete/') , 'method' => 'post' ,
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-9">
			  <input class="form-control" type="number" id="id_santri_name" name="id_santri_name" VALUE="{{ $id_santri_name}}" READONLY />
		</div>
	</div>
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-9">
			  <input class="form-control" type="text" id="date_name" name="date_name" VALUE="{{ $date_name}}" READONLY/>
		</div>
	</div>
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-9">
			  <input class="form-control" type="number" id="id_pelanggaran_name" name="id_pelanggaran_name" VALUE="{{ $id_pelanggaran_name}}" READONLY />
		</div>
	</div>
